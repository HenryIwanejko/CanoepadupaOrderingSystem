...
namespace CanoepadupaOrderingSystem.Services
{
    public class DatabaseService
    {
        ...
        public static List<Customer> GetAllCustomers()
        {
            ...
            {
                throw new DatabaseException("Failed to get all customers");
            }
        }
        ...
        public static List<Product> GetAllProducts()
        {
            ...
            {
                throw new DatabaseException("Failed to get all products");
            }
        }
        ...
        public static List<Order> GetAllOrdersForCustomer(Customer customer)
        {
            ...
            {
                throw new DatabaseException("Failed to get all orders for customer");
            }
        }
        ...
        public static List<OrderItem> GetAllOrderItemsForOrder(Order order)
        {
            ...
            {
                throw new DatabaseException("Failed to retrieve all order items for order");
            }
        }
        ...
        public static void AddOrderItem(OrderItem orderItem)
        {
            ...
            {
                throw new DatabaseException("Failed to add order item");
            }
        }
        ...
        public static int GetNextOrderNumber()
        {
            ...
            {
                throw new DatabaseException("Failed to get max order number");
            }
        }
        ...
        public static void AddCustomer(Customer customer)
        {
            ...
            {
                throw new DatabaseException("Failed to add customer to database");
            }
        }
